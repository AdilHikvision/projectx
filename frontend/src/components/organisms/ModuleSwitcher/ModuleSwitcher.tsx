                    ...
                    {MODULE_LIST.map((m) => {
                        ...
                        return (
                            <button
                                ...
                                className={`group relative flex aspect-[3/4] flex-col justify-end overflow-hidden rounded-2xl border border-border-light bg-surface text-left shadow-card transition-all duration-300 hover:-translate-y-0.5 hover:border-primary/30 hover:shadow-float focus:outline-none ${
                                    isActive ? 'ring-2 ring-primary shadow-float' : ''
                                }`}
                            >
                                {/* module image */}
                                <img
