...
export function PersonDetailPage() {
  ...
  async function handleAddFace() {
    ...
    try {
      ...
      if (!res.ok) {
        throw new Error(data.message || 'Failed to upload face')
      }
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="space-y-6">
              ...
              <div className="p-6 bg-primary/5 rounded-3xl border border-primary/10 space-y-4">
                ...
                <Button fullWidth variant="outline" icon="edit" size="md" onClick={() => navigate('/people', { state: { openEdit: true, editId: id, editType: type } })}>Edit Profile</Button>
                <Button fullWidth variant="danger" icon="delete" size="md" onClick={() => setDeleteConfirmOpen(true)}>Retire Profile</Button>
